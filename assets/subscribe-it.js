  ...
  .slider.round:before {
    ...
    SI.Config = {
      ...
      "labels": {
        ...
        "content_for_body": "<!-- Global site tag (gtag.js) - Google Analytics -->\n<script async src=\"https:\/\/www.googletagmanager.com\/gtag\/js?id=UA-221591010-1\"><\/script>\n<script>\n  window.dataLayer = window.dataLayer || [];\n  function gtag(){dataLayer.push(arguments);}\n  gtag('js', new Date());\n\n  gtag('config', 'UA-221591010-1');\n<\/script>",
      ...
      "partials": {},
        ...
        "shop": "brandon-blackwood-new-york.myshopify.com",
        ...
        SI.Config.shop = 'brandon-blackwood-new-york.myshopify.com';
